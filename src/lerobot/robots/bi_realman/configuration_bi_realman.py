...
@dataclass
class BiRealmanConfig(RobotConfig):
    """
    Configuration class for the BiRealman robot.
...
@dataclass
class BiRealmanEndEffectorConfig(BiRealmanConfig):
    """
    Configuration class for the end effector of the BiRealman robot.
